<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="BulkSMS.aspx.cs" Inherits="ChurchAppDemo.Main.BulkSMS" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                         ...
                         <telerik:RadGrid ID="memberGrid" runat="server" AllowMultiRowSelection="true" AutoGenerateColumns="False"  GroupPanelPosition="Top" AllowFilteringByColumn="True" AllowPaging="False" AllowSorting="True" CellSpacing="-1" DataSourceID="memeberSource" GridLines="Both" OnItemDataBound="memberGrid_ItemDataBound">
                            <ClientSettings>
                        ...
                        <asp:SqlDataSource ID="memeberSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT MemberID, Surname, Othername, Gender, Department, Telephone FROM Members Where Active = 1" DeleteCommand="DELETE FROM [Members] WHERE [MemberID] = @MemberID">
                            <DeleteParameters>
